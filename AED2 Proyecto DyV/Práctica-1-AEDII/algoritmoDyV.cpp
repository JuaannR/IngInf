...
// Genera una cadena aleatoria de tamaño n con caracteres en [a, b], así simulamos el caso promedio, que tendrá
// un tiempo de ejecución similar al caso mejor ya que el caso peor es totalmente improbable para valores m grandes
...
// Genera una cadena con solo el carácter C, esto provoca que el tiempo de combinar sea máximo
